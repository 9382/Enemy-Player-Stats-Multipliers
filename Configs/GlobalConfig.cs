...
namespace WhisStatsConfig
{
    ...
    public static class GlobalConfig
    {
		...
		public static float GlobalItemDefenseMultiplier = 1.0f; //changed to "itemdefense"
		...
		static bool ReadConfig()
        {
            if(Configuration.Load())
            {
				...
				Configuration.Get("GlobalItemDefenseMultiplier", ref GlobalItemDefenseMultiplier);
		...
		static void CreateConfig()
        {
            Configuration.Clear();
				...
				Configuration.Put("GlobalItemDefenseMultiplier", GlobalItemDefenseMultiplier);
